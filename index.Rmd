...
## Results are accompanoied with the data and code used to produce them
...
dates <- ymd_hms(dates)  # from lubridate
...
## _Relative_ Frequency is More Informative
...
- At its core, topic modelling is an unsupervised learning exercise.  

- This leaves lots of room for discretion and interpretation.  
...
---
# Which Words Contribute Most for Each Topic?
