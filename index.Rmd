...
These papers
  ...
  - assemble a novel dataset on international central bank announcments.
...
- In my view, the paper's main contributions are  
  ...
  1. Generating a rich, international data sets on central bank announcments.
...
- One idea, one paper: I think the authors must choose between forecasting and transparency indicators.
---
