...
- Presents (too) many interesting insights.
...
- Focus on a specific application (Forecasting or Transparency)
...
- The code to reproduce many of the figures in the text is missing.  
...
- In my view, the paper's main contributions are  
  
  1. Generating a rich, international text-related data sets.
  2. Providing evidence on interest rate predictability.
  3. Provide novel measures for transparency.

- Unfortunately, these contributions are currently presented as "Applications".  

- I recommend highlighting results and data rather than methodologies.

- One idea, one paper: I think the authors must choose between forecasting and transparency.
---
